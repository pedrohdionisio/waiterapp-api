...
// src/server/functions/ingredients/listIngredients.ts
var listIngredients_exports = {};
__export(listIngredients_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(listIngredients_exports);
...
// src/app/modules/ingredients/schemas/CreateIngredient.schema.ts
var CreateIngredientSchema = z.object({
  name: z.string(),
  icon: z.string()
});

// src/app/modules/ingredients/schemas/DeleteIngredient.schema.ts
var DeleteIngredientSchema = z.object({
  name: z.string()
});
...
// src/app/modules/ingredients/controllers/create-ingredient/CreateIngredient.controller.ts
var import_client_cognito_identity_provider = require("@aws-sdk/client-cognito-identity-provider");
var import_client_dynamodb = require("@aws-sdk/client-dynamodb");

// src/app/modules/ingredients/controllers/delete-ingredient/DeleteIngredient.controller.ts
var import_client_cognito_identity_provider2 = require("@aws-sdk/client-cognito-identity-provider");

// src/app/modules/ingredients/controllers/list-ingredients/ListIngredients.controller.ts
var import_client_cognito_identity_provider3 = require("@aws-sdk/client-cognito-identity-provider");
var ListIngredientsController = class {
  constructor(listIngredientsService) {
    this.listIngredientsService = listIngredientsService;
  }
  async handle() {
    try {
...
// src/app/modules/ingredients/services/list-ingredients/ListIngredients.service.ts
...
// src/app/database/repositories/ingredients/Ingredients.repository.ts
var import_lib_dynamodb = require("@aws-sdk/lib-dynamodb");
var import_ulid = __toESM(require_index_umd());
var IngredientsRepository = class {
  constructor(dynamoClient2) {
...
// src/factories/repositories/ingredients/makeIngredientsRepository.factory.ts
function makeIngredientsRepository() {
  return new IngredientsRepository(dynamoClient);
}

// src/factories/services/ingredients/makeListIngredientsService.factory.ts
function makeListIngredientsService() {
  return new ListIngredientsService(makeIngredientsRepository());
}

// src/factories/controllers/ingredients/makeListIngredientsController.factory.ts
function makeListIngredientsController() {
...
//# sourceMappingURL=listIngredients.js.map
