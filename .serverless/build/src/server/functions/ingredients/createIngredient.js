...
// src/server/functions/ingredients/createIngredient.ts
var createIngredient_exports = {};
__export(createIngredient_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(createIngredient_exports);
...
var CreateIngredientController = class {
  constructor(createIngredientService) {
...
// src/app/modules/ingredients/services/create-ingredient/CreateIngredient.service.ts
...
// src/factories/services/ingredients/makeCreateIngredientService.factory.ts
function makeCreateIngredientService() {
  return new CreateIngredientService(makeIngredientsRepository());
}

// src/factories/controllers/ingredients/makeCreateIngredientController.factory.ts
function makeCreateIngredientController() {
...
//# sourceMappingURL=createIngredient.js.map
