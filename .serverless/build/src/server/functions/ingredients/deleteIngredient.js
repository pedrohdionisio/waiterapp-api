...
// src/server/functions/ingredients/deleteIngredient.ts
var deleteIngredient_exports = {};
__export(deleteIngredient_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(deleteIngredient_exports);
...
var DeleteIngredientController = class {
  constructor(deleteIngredientService) {
...
// src/app/modules/ingredients/services/delete-ingredient/DeleteIngredient.service.ts
...
// src/factories/services/ingredients/makeDeleteIngredientService.factory.ts
function makeDeleteIngredientService() {
  return new DeleteIngredientService(makeIngredientsRepository());
}

// src/factories/controllers/ingredients/makeDeleteIngredientController.factory.ts
function makeDeleteIngredientController() {
...
async function handler(event) {
  const controller = makeDeleteIngredientController();
