...
var UsersRepository = class {
  ...
  async create(dto) {
    const cognitoCommand = new import_client_cognito_identity_provider2.SignUpCommand({
...
var cognitoClient = new import_client_cognito_identity_provider3.CognitoIdentityProviderClient();
