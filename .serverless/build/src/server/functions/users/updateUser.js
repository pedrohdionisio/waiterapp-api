...
var UsersRepository = class {
  ...
  async create(dto) {
    const cognitoCommand = new import_client_cognito_identity_provider5.SignUpCommand({
  ...
  async delete(dto) {
    const cognitoCommand = new import_client_cognito_identity_provider5.AdminDeleteUserCommand({
  ...
  async update(dto) {
    const cognitoCommand = new import_client_cognito_identity_provider5.AdminUpdateUserAttributesCommand({
      Username: dto.email,
      UserPoolId: process.env.COGNITO_USER_POOL_ID,
      UserAttributes: [
        {
...
var cognitoClient = new import_client_cognito_identity_provider6.CognitoIdentityProviderClient();
