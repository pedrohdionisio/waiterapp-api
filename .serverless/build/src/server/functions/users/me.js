...
// src/server/functions/users/me.ts
var me_exports = {};
__export(me_exports, {
  handler: () => handler
});
...
var MeController = class {
  ...
  async handle(request) {
    try {
      ...
      if (error instanceof import_client_cognito_identity_provider5.NotAuthorizedException) {
        return {
          statusCode: 401,
          body: {
...
// src/app/modules/users/services/me/Me.service.ts
var MeService = class {
...
// src/factories/services/users/makeMeService.factory.ts
function makeMeService() {
  return new MeService(makeUsersRepository());
}

// src/factories/controllers/users/makeMeController.factory.ts
function makeMeController() {
