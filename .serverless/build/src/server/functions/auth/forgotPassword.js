...
// src/server/functions/auth/forgotPassword.ts
...
var ForgotPasswordController = class {
  ...
  async handle(request) {
    try {
      ...
      if (error instanceof import_client_cognito_identity_provider4.UserNotFoundException) {
        return {
          statusCode: 404,
          body: {
...
// src/app/modules/auth/services/forgot-password/ForgotPassword.service.ts
var ForgotPasswordService = class {
...
// src/factories/services/auth/makeForgotPasswordService.factory.ts
function makeForgotPasswordService() {
  return new ForgotPasswordService(makeAuthRepository());
}

// src/factories/controllers/auth/makeForgotPasswordController.factory.ts
