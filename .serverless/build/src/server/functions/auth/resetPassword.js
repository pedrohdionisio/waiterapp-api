...
// src/server/functions/auth/resetPassword.ts
...
var ResetPasswordController = class {
  ...
  async handle(request) {
    try {
      ...
      if (error instanceof import_client_cognito_identity_provider5.CodeMismatchException) {
        return {
          statusCode: 409,
          body: {
      ...
      if (error instanceof import_client_cognito_identity_provider5.ExpiredCodeException) {
        return {
          statusCode: 400,
          body: {
      ...
      if (error instanceof import_client_cognito_identity_provider5.UserNotFoundException) {
        return {
          statusCode: 404,
          body: {
...
// src/app/modules/auth/services/reset-password/ResetPassword.service.ts
var ResetPasswordService = class {
...
// src/factories/services/auth/makeResetPasswordService.factory.ts
function makeResetPasswordService() {
  return new ResetPasswordService(makeAuthRepository());
}

// src/factories/controllers/auth/makeResetPasswordController.factory.ts
function makeResetPasswordController() {
  return new ResetPasswordController(makeResetPasswordService());
}

// src/server/adapters/publicRequest.adapter.ts
function publicRequestAdapter(event) {
  const request = {
